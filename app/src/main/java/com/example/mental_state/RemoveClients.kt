...
class RemoveClients : AppCompatActivity() {
    ...
    private lateinit var selectedClientName: String
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            enableEdgeToEdge()
            setContentView(R.layout.activity_remove_clients)
                ...
                .addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        if (snapshot.exists()) {
                            ...
                            Toast.makeText(this@RemoveClients, "No clients found", Toast.LENGTH_SHORT).show()
                        }
                    }

                    override fun onCancelled(error: DatabaseError) {
                        Toast.makeText(this@RemoveClients, "Error: ${error.message}", Toast.LENGTH_SHORT).show()
                    }
                })
        }
            ...
            usersRef.orderByChild("email").equalTo(email)
                .addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        Toast.makeText(this@RemoveClients, "Client removed from users", Toast.LENGTH_SHORT).show()
                    }
